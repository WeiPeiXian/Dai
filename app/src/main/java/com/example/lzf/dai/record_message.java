...
public class record_message extends AppCompatActivity implements View.OnClickListener{
    private Button back;
    private Button edit;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        ed8.setMinHeight(100);
        ed8.setMinimumHeight(100);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.title_back:
                Intent it= new Intent(record_message.this,record.class);
            ...
            case R.id.title_edit:
                Intent it1= new Intent(record_message.this,change_record_message.class);
                ...
                bd1.putString("participant",String.valueOf(ed6.getText()));
