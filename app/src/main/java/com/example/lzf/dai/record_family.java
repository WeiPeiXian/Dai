...
public class record_family extends AppCompatActivity implements View.OnClickListener{
    private Button back;
    private Button edit;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.record_family);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.title_back:
                Intent it= new Intent(record_family.this,record.class);
            ...
            case R.id.title_edit:
                Intent it1= new Intent(record_family.this,change_record_family.class);
                ...
                bd1.putString("recorder", String.valueOf(ed7.getText()));
                bd1.putString("way",String.valueOf(ed6.getText()));
                bd1.putString("content",String.valueOf(ed8.getText()));
                bd1.putString("comment",String.valueOf(ed9.getText()));
                bd1.putString("witness",String.valueOf(ed3.getText()));
