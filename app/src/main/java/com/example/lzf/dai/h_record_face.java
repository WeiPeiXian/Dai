...
public class h_record_face extends AppCompatActivity implements View.OnClickListener{
    private Button back;
//    private Button edit;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.h_record_face);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.title_back:
                Intent it= new Intent(h_record_face.this,h_record.class);
